...
public class TestMajorServiceImpl {
    ...
    public void testInsertMajor(){
        ...
        major.setMajorName("Mechatronic Engineering");
        major.setMajorCode("MC_50801");
    ...
    public void testSelectMajor(){
        List<Major> majorList = majorMapper.selectList(new QueryWrapper<Major>().like("major_code","MC_508"));
        majorList.forEach(System.out::println);
    }

    @Test
    public void testSelectCounr(){
        System.out.println(majorMapper.selectCount(new QueryWrapper<Major>().like("major_code","MC_508")));
    }
}
